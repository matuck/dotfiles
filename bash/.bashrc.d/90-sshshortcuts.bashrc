...
alias shp='sshpass -p$(bwpass jones) ssh -l jones -oStrictHostKeyChecking=no '
alias shu='sshpass -p$(bwpass password csa) ssh -l csa_mitch_tuck -oStrictHostKeyChecking=no '
